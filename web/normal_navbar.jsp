<nav class="navbar navbar-expand-lg navbar-dark primary-background">
    <a class="navbar-brand" href="index.jsp"><span class="fa fa-asterisk"></span>Promo Plus</a>
...
<!--      <li class="nav-item active">
      ...
      <li class="nav-item ">
          <a class="nav-link text-white" href="#" > <span class="fa fa-mobile " ></span>Contact Us</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="#">Creating ad</a>
          <a class="dropdown-item" href="#"></a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="#">Full advertisement</a>
        </div>
      </li>
       <li class="nav-item">
